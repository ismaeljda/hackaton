...
class FlightSearchService:
    ...
    def search_flights(self, search_params):
        ...
        return_date_max = search_params.get('return_date_max')
        ...
        for origin in departure_airports:
            try:
                ...
                # Use return_date_max if provided, otherwise calculate from latest_departure
                if return_date_max:
                    return_date_to = return_date_max
                else:
